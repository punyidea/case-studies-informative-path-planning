...
### TO BE DELETED SOON, JUST FOR DEMONSTRATION PURPOSES
class TestParabolicSolver(TestCase):
    mesh,fn_space = pde_utils.setup_function_space(100)
    LHS = staticmethod(pde_utils.elliptic_LHS_const)
    RHS = staticmethod(pde_utils.elliptic_RHS)
